...
import { getCurrentHighestZIndex, getObjectFromMap, getToolById, } from "../../utils/utils";
import { getSelectedIdsFromFullState, selectElement, selectManyElements, unselectAll, } from "../../utils/select/utils";
...
const duplicateTool = {
    ...
    icon: React.createElement(DuplicateIcon, null),
    getDisplayMode(ctx) {
 ...
 */
export function duplicateSelectedObjects(ctx) {
    const selectedIds = getSelectedIdsFromFullState(ctx);
...
function duplicateObject(object, ctx) {
    ...
    const data = {
        ...
        element: newDiv.lastElementChild,
        style: {
            ...object.style,
