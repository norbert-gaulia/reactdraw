...
export default function LineWidthPicker({ onUpdate, styleKey, styleValue, }) {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { textAlign: "left", marginBottom: 5 } },
            React.createElement("label", { style: { fontWeight: "bold" }, htmlFor: id.current },
                "opacity (",
                styleValue,
                ")")),
        React.createElement("div", { style: { width: "100%" } },
            React.createElement("input", { id: id.current, value: styleValue, onChange: handleChange, type: "range", style: {
