export default function cssFromState(state) {
    let finalCss = "";
...
function compileClasses(className, styles) {
    ...
    for (const [property, value] of entries) {
        if (typeof value === "string" || typeof value === "number") {
            ...
            cssString += compileClasses(cls + " " + property.replace(/&/g, cls), value);
        }
...
function makeKeyframes(kf, defs) {
...
function makeMediaCss(mediaQuery, cls, styles) {
