...
import { redoDelete, saveCreateToUndoStack, undoCreate, undoEleBackgroundColor, undoEleBorderColor, undoEleLineWidth, undoEleOpacity, } from "../../utils/undo";
import { borderFromStyles, updateEleBackgroundColor, updateEleBorderColor, } from "../../utils/updateStyles/color";
import { updateEleLineWidth } from "../../utils/updateStyles/linewidth";
import { updateEleOpacity } from "../../utils/updateStyles/opacity";
const circlTool = {
    id: CIRCLE_TOOL_ID,
    tooltip: "Circle tool",
    icon: React.createElement(CircleBoldIcon, null),
    onDrawStart: (data) => {
...
export function makeCircleDiv(styles) {
