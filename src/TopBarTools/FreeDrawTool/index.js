...
import { distance, expandContainer, getBoxSize, mapPointToRect, scaleSvg,
//   makeRelativeDiv,
 } from "../../utils";
...
const freeDrawTool = {
    ...
    icon: React.createElement(PencilBoldIcon, null),
    onDrawStart: (data) => {
...
function getPathPoint(curr, index) {
    if (index === 0) {
...
function saveOriginalBoundsToData(data) {
