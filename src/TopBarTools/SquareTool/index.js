...
import { updateEleBackgroundColor, updateEleBorderColor, } from "../../utils/updateStyles/color";
import { updateEleLineWidth } from "../../utils/updateStyles/linewidth";
import { updateEleOpacity } from "../../utils/updateStyles/opacity";
const squareTool = {
    id: SQUARE_TOOL_ID,
    tooltip: "Square Tool",
    icon: React.createElement(SquareBoldIcon, null),
    onDrawStart: (data) => {
...
export function makeSquareDiv(style) {
