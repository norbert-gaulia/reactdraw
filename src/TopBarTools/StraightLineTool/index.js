...
import { CUSTOM_DATA_ORIENT_KEY, STRAIGHT_LINE_TOOL_ID, } from "../../constants";
...
const straightLineTool = {
    ...
    icon: React.createElement(HorizontalLineIcon, null),
    onDrawStart: (data) => {
...
export function makeLineInOrientation(data, orientation) {
