...
export function resizeNE(data, ctx) {
    ...
    const [dxWithAspectRatio, _y] = forcePreserveAspectRatio([dX, dY], data, aspectRatioEN);
    const aspectRatioNE = getAspectRatioInput(data, ctx, "NE");
    const [_x, dyWithAspectRatio] = forcePreserveAspectRatio([dX, dY], data, aspectRatioNE);
