...
export function resizeNW(data, ctx) {
    ...
    const [dxWithAspectRatio, _y] = forcePreserveAspectRatio([dX, dY], data, aspectRatioWN);
    const aspectRatioNW = getAspectRatioInput(data, ctx, "NW");
    const [_x, dyWithAspectRatio] = forcePreserveAspectRatio([dX, dY], data, aspectRatioNW);
