...
export function resizeSW(data, ctx) {
    ...
    const [dxWithAspectRatio, _y] = forcePreserveAspectRatio([dX, dY], data, aspectRatioWS);
    const aspectRatioSW = getAspectRatioInput(data, ctx, "SW");
    const [_x, dyWithAspectRatio] = forcePreserveAspectRatio([dX, dY], data, aspectRatioSW);
