...
export function createPathSvg(style) {
...
export function createLineSvg(style) {
...
export function createSvg(w, h, opacity) {
    if (!isBrowser()) {
...
export function createPath(style) {
    if (!isBrowser()) {
...
export function makeLineSvgEle(pointA, pointB, style, mapFn) {
